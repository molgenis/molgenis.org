...
## Coordination
MOLGENIS was initiated and is currently coordinated by Prof.Dr. Morris Swertz of the Genomics Coordination Center (GCC), kindly hosted by the Department of Genetics of the University Medical Center Groningen. Please contact at: <a href="mailto:support@molgenis.org">support@molgenis.org</a>. MOLGENIS is funded by a large range of public projects from various academic sponsors (see PartnerS below).
...
## Hosting and support
MOLGENIS is open source and free to download and install yourself. You can also get a MOLGENIS instance ready for use from us. We can also provide support with entering and managing your data. Please contact us for details and costs.
