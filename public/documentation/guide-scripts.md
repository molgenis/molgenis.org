...
# Create a script
You open the script editor by clicking the add button ![image](../res/images/new.png).
...
# Running a script
You can run your script by pressing the ![image](../res/images/execute.png) execute button.
...
## Call the script
Push the ![image](../res/images/execute.png) execute button.

In the popup, specify the value for `snp_id`, for example `rs2287988`.

Push Run.

![image](../res/images/rs2287988.png)